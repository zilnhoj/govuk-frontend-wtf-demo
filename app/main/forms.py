...
class KitchenSinkForm(FlaskForm):
    ...
    radio_field = RadioField(
        "Choose a circuits option",
        widget=GovRadioInput(),
        validators=[InputRequired(message="Please select an option")],
        choices=[("twelvex40sx2", "Twelve x 40s x 2"), ("6x1x3", "6 x 1min x 3reps"), ("4x12x3", "4 by 12 reps by 3 sets")],
        description="Hint text: Choose and option.",
    )
...
class ConditionalRevealForm(FlaskForm):
    choose_circuits_session = RadioField(
        "Choose the session option you want",
        widget=GovRadioInput(),
        validators=[InputRequired(message="Choose the session option you want")],
        choices=[
            ("12x40sx2", "12 by 40secs 2 sets"),
            ("6x1x3", "6 by 1min 3 sets"),
            ("4x12repsx3", "4 by 12 reps by 3 sets"),
        ],
        description="Select one option.",
    )

    twelvex40sx2 = StringField(
        "12 by 40secs 2 sets",
        widget=GovTextInput(),
        ...
        validators=[RequiredIf("choose_circuits_session", "12x40sx2", message="Choose 12 by 40 by ")],
    )

    sixx1x3 = StringField(
        "6 by 1min 3 sets",
        widget=GovTextInput(),
        validators=[RequiredIf("choose_circuits_session", "6x1x3", message="6 by 1min 3 sets")],
    )

    fourx12repsx3 = StringField(
        "4 by 12 reps by 3 sets",
        widget=GovTextInput(),
        validators=[
            RequiredIf(
                "choose_circuits_session",
                "4x12repsx3",
                message="4 by 12 reps by 3 sets",
            )
        ],
    )
